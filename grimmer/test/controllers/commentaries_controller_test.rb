...
class CommentariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commentary" do
    assert_difference('Commentary.count') do
      post commentaries_url, params: { commentary: { city: @commentary.city, country: @commentary.country, post_id: @commentary.post_id, texto: @commentary.texto, user_id: @commentary.user_id } }
    end
  ...
  test "should update commentary" do
    patch commentary_url(@commentary), params: { commentary: { city: @commentary.city, country: @commentary.country, post_id: @commentary.post_id, texto: @commentary.texto, user_id: @commentary.user_id } }
